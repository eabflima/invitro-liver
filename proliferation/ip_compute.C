...
void computeIP(const QUESO::FullEnvironment& env)
{
  ...
  QUESO::VectorSpace<QUESO::GslVector, QUESO::GslMatrix>
    paramSpaceA(env, "paramA_", 3, NULL);
  QUESO::VectorSpace<QUESO::GslVector, QUESO::GslMatrix>
    paramSpaceB(env, "paramB_", 2, NULL);
  QUESO::VectorSpace<QUESO::GslVector, QUESO::GslMatrix>
  ...
  paramMinsA[0] = input_data("v_l_p_min",0.10);
  paramMinsA[1] = input_data("v_l_k_min",1000.0);
  paramMinsA[2] = input_data("v_std_min",10.0);
  QUESO::GslVector paramMaxsA(paramSpaceA.zeroVector());
  paramMaxsA[0] = input_data("v_l_p_max",0.55);
  paramMaxsA[1] = input_data("v_l_k_max",200000.0);
  paramMaxsA[2] = input_data("v_std_max",20000.0);
